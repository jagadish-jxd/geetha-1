...
export function initMemoryPage() {
  ...
  // Make sure background music listener is active if opened directly
  ...
  // Celebration Shower when all memories are discovered
...
// If loaded directly as standalone memory.html
if (document.getElementById('memoryAlbum')) {
  initMemoryPage();
}
